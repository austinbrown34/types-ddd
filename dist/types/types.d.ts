import { IUseCase, IResultHook, EntityMapperPayload, IAdapter, IAggregate, IAutoMapper } from 'rich-domain/types';
import { Result } from '../core';
import { UID, OBJ, IValueObject, ITeratorConfig, ISettings, IResultOptions, IResultObject } from 'rich-domain/types';
import { IResultExecute, IResult, IReplaceOptions, IPublicHistory, ICommand } from 'rich-domain/types';
import { IDispatchOptions, IProxy, IIterator, IEvent, IHandle, IHistory, IEntityHistory } from 'rich-domain/types';
 ...
 * // ...
 */
export declare type ICanExecuteProxy<Data, Error> = IUseCase<Data, Result<boolean, Error>>;
/**
 ...
 * // ...
 */
export declare type IAfterHookProxy<Payload, Error> = IUseCase<Result<Payload, Error>, Result<Payload, Error>>;
/**
 ...
 *
 */
export declare type IBeforeHookProxy<Data, Error> = IUseCase<Data, Result<Data, Error>>;
/**
...
export { Filter, IResultHook, EntityMapperPayload, IAdapter, IAggregate, IAutoMapper, UID, OBJ, IValueObject, ITeratorConfig, ISettings, IResultOptions, IResultObject, IResultExecute, IResult, IReplaceOptions, IPublicHistory, ICommand, IDispatchOptions, IProxy, IIterator, IEvent, IHandle, IHistory, IEntityHistory, IGettersAndSetters, IParentName, };
