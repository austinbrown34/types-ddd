...
declare enum AvailableOrderStatus {
    'PENDING' = "PENDING",
...
export declare type AvailableOrderStatusType = keyof typeof AvailableOrderStatus;
 ...
 */
declare class OrderStatusValueObject extends ValueObject<OrderStatusProps> {
    private constructor();
    /**
     * @returns status
     */
    ...
    static isValidProps: (status: AvailableOrderStatusType) => boolean;
    static create(value: AvailableOrderStatusType): Result<OrderStatusValueObject>;
}
